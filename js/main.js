...
let rightNavbar = document.querySelector('.right__navbar')
let closeItem = document.querySelector('.left__block-close')
let headerMenu = document.querySelector('.header__menu')
let headerClose = document.querySelector('.right__navbar-close')

burgerItem.addEventListener('click', () => {
	leftBlock.classList.add('left__block_active')
})
closeItem.addEventListener('click', () => {
	leftBlock.classList.remove('left__block_active')
})
headerMenu.addEventListener('click', () => {
	rightNavbar.classList.add('right__block_active')
})
headerClose.addEventListener('click', () => {
	rightNavbar.classList.remove('right__block_active')
})
